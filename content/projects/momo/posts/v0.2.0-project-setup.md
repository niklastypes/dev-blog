---
title: v0.2.0 - Project Setup
date: 2025-12-11
draft: false
description: Release notes for Momo v0.2.0 from Niklas' perspective.
tags: [momo]
authors:
  - niklas
---
...
{{< alert >}}
**Disclaimer!** 
*This might be the least exciting step in the whole project but a nonetheless very important one to keep a consistently high quality from the very start, following established and best practice software engineering practices.*
{{< /alert >}}
...
{{< button href="https://gitlab.com/niklasbaier/momo/-/releases/v0.2.0" >}}
